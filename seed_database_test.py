...
os.system("dropdb dest_a11y_test_db")
os.system("createdb dest_a11y_test_db")

model.connect_to_db(server.app, "postgresql:///dest_a11y_test_db")
...
with open('data/users_test.json') as f:
...
# # Load data from JSON file
with open('data/businesses_55438_test.json') as f:
